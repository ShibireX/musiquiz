...
struct ArtistQuizView: View {
    ...
    var body: some View {
        ZStack {
            LinearGradient(colors: [Color(red: 253/255, green: 187/255, blue: 81/255), Color(red: 250/255, green: 220/255, blue: 95/255)], startPoint:.top, endPoint: .bottom).ignoresSafeArea()
            NavigationLink {
                HomeView()
            } label: {
                                ...
                                Button() {
                                    ...
                                    DispatchQueue.main.asyncAfter(deadline: .now() + 0.5) {
                                        ...
                                        if artists.count >= 5 && questionNumber < totalQuestions {
                                            ...
                                            if totalPoints > highScoreManager.highScore {
                                                highScoreManager.highScore = totalPoints
                                            }
                                        }
                                    }
                                } label: {
...
struct ArtistQuizView_Previews: PreviewProvider {
    ...
    static var previews: some View {
        ArtistQuizView(artists: [Artistt(artistId: "0", popularity: 0)], gradientColors: [.blue])
